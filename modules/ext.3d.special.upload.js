...
mw.threed.specialUpload = {
	...
	onChangeFile: function () {
		...
		const supported3dExtensions = ['stl', 'gltf', 'glb'];
		const hasStlFiles = Array.prototype.some.call(files, (file) => supported3dExtensions.indexOf(file.name.split('.').pop().toLowerCase()) !== -1);
